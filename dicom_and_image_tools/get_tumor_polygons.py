                ...
                if int(malignancy_min) <= int(malignancy):
                    for roi in nodule.iter("{0}roi".format(ns)):
                        ...
                        if area == 0 and len(coords) > 3:
                            eprint(
                                "NOTICE: Annotation with zero area found; nodule ID {0}, z={1}, # of annotation points: {2}".format(
                        ...
                        if area > 0:
                            ...
                            polygon["malignancy"] = (
                                malignancy if malignancy != None else 0
                            )
